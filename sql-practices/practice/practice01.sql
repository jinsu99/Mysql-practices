...
select 	count(case when gender='F' then 1 end) as '여직원수',
		count(case when gender='M' then 1 end) as '남직원수'
from employees;
...
select count(salary) from salaries where salary > 120000 and to_date = '9999-01-01';
...
select * from titles where title='Engineer' and to_date = '9999-01-01';
